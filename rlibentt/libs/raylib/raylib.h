...
typedef struct Camera3D {
    ...
    float walkspeed; //RA added to dynamically change the movement speed
    bool override;
    float override_dirx;
    float override_diry;
    bool oobx, oobz;
...
void UpdatePosition(Camera *camera);                        //Update the camera position and store the previous position
void ExUpdatePosition(Camera *camera);                      // Update extraneous camera details
